...
impl AIChatProcess {
    ...
    pub async fn send_input(&mut self, target_process: Option<usize>) -> Result<()> {
        ...
        let history: Vec<ChatMessage> = self
            ...
            .filter_map(|msg| match msg.role {
                ...
                MessageRole::Assistant => Some(ChatMessage::assistant(msg.content.clone())),
    ...
    fn check_for_commands(&mut self, response: &str, target_process: Option<usize>) {
